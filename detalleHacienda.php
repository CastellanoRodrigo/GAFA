...
<div class="centrado">
  ...
  <div class="centrado--form">
    <form action="./agrDetalleHacienda.php" method="POST" class="centrado--form--form">
      <div class="labelInput">
        <label for="name">Nombre del proyecto:</label>
        <select name="cmbNombre" required>
          <option value="" selected disabled="cmbnombre">-SELECCIONE UNA-</option>
          <?php
          $consulta= "SELECT * FROM proyectos WHERE id_Proyecto NOT IN (SELECT id_Proyecto FROM detallehacienda) AND id_TipoProyecto = '1'";
